...
describe('Walker', () => {
  it('should create a walker with the given position', () => {
    const walker = new Walker(10, 20, mockP5 as unknown as p5)
  ...
  it('should create a walker at origin when coordinates are zero', () => {
    const walker = new Walker(0, 0, mockP5 as unknown as p5)
  ...
  it('should handle negative coordinates', () => {
    const walker = new Walker(-5, -10, mockP5 as unknown as p5)
  ...
  it('should handle floating point coordinates', () => {
    const walker = new Walker(3.14, 2.71, mockP5 as unknown as p5)
  ...
  it('should call p5 stroke and point methods when showing', () => {
    ...
    expect(mockP5.stroke).toHaveBeenCalledWith(0)
